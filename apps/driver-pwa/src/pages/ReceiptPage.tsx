...
export function ReceiptPage() {
  ...
  return <>
    ...
    <section className="receipt-card">
      <div className="receipt-success"><span><AppIcon name="check" size={30} /></span><div><StatusChip label="Pagamento concluído" tone="success" /><h2>{currency.format(receipt.totalAmount)}</h2><p>Pagamento processado pela Stripe</p></div></div>
